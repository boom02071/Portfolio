...
//			resultMap.put("info", info);
	...
	@PostMapping("/regist")
	public ResponseEntity<String> registMember(@RequestBody Member member) throws Exception {
	...
	@PutMapping("/change")
	public ResponseEntity<String> updateMember(@RequestBody Member member) throws Exception {
